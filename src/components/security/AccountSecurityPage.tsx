...
import { ArrowLeft, ShieldCheck, User, Lock, Clock, Key, Activity, AlertTriangle } from 'lucide-react-native';
...
type Tab = 'profile' | 'security' | 'sessions' | 'licensing' | 'activity' | 'danger';
